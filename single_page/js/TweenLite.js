			...
			(function(){
				...
				for(var i=0;i<attrArr.length;i++){
					...
					if(attrArr[i]=='alpha'){
						...
						target.style.MozTransform = "rotate("+ easeVars +"deg)";
						target.style.webkitTransform = "rotate("+ easeVars +"deg)";
						target.style.OTransform = "rotate("+ easeVars +"deg)";
						target.style.transform = "rotate("+ easeVars +"deg)";
